    ...
    return (
      <span className="inline-flex items-center gap-1.5">
        <span className="text-xs text-slate-400 line-through dark:text-slate-500">
          {t("ils", { price: previousPriceIls })}
        </span>
        <span className="inline-block rounded-full bg-rose-100 px-3 py-1 text-sm font-semibold text-rose-700 ring-1 ring-rose-200 dark:bg-rose-900/60 dark:text-rose-100 dark:ring-rose-800">
